...
const PopularProducts = () => {
  ...
  return (
   <section id="products" className='max-conatiner max-sm:mt-12'>
    ...
    <div className="mt-14 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-14 sm:gap-4">
      {
